...
protected:
    virtual void setupParams() override
    {
        ...
        std::vector<real_T> arm_lengths(params.rotor_count, 0.566f);

        //set up mass
        params.mass = 10.0f; //can be varied from 0.800 to 1.600
        real_T motor_assembly_weight = 0.300f;  //weight for MT2212 motor for F450 frame
        ...
        params.rotor_params.max_rpm = 4000.0f;
        params.rotor_params.propeller_diameter = 0.5334f;
        params.rotor_params.propeller_height = 2.5 / 100.0f;
        params.rotor_params.calculateMaxThrust();

        //set up dimensions of core body box or abdomen (not including arms).
        params.body_box.x() = 0.437f; params.body_box.y() = 0.402f; params.body_box.z() = 0.553f;
