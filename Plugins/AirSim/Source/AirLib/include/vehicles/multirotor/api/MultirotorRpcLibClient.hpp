...
public:
    ...
    MultirotorRpcLibClient* moveByRollPitchYawrateZrateAsync(float roll, float pitch, float yaw_rate, float throttle, float duration, const std::string& vehicle_name = "");
